...
describe('check links on stage pages', () => {
  ...
  //   // check links on page
  //   cy.get('[href="https://vip.sos.nd.gov/PortalList.aspx?ref=voteusa_en"]').then(links =>{cy.get(links[1])
  //   .click()
  //   cy.url().should('be.equal', 'https://vip.sos.nd.gov/PortalList.aspx?ref=voteusa_en')
  //   cy.go('back')
  // })

  cy.get('[href="https://vip.sos.nd.gov/PortalList.aspx?ref=voteusa_en"]').click({ multiple: true })
